...
class GameViewController: UIViewController {
    ...
    @IBAction func buttonBoardPress(_ sender: UIButton){
...
// if all buttons (Board are full) this function gives a alert massage
    func drawAlert(){
    ...
    // give a alert if som one of the player wins win
    func winAlert(){
